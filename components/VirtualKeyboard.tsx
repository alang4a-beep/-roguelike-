...
export const VirtualKeyboard: React.FC<VirtualKeyboardProps> = ({ activeKey, pressedKey, showHints }) => {
  return (
      ...
      {CORRECT_KEYBOARD_ROWS.map((row, rowIndex) => (
        <div key={rowIndex} className="flex justify-center gap-1.5 sm:gap-2">
          {row.map((keyConfig) => {
            ...
            let bgClass = "bg-gray-700 hover:bg-gray-600 border-gray-600";
            ...
            return (
              <div
                ...
                className={`
                  ...
                  border-b-4 rounded-lg transition-all duration-100
                  ${bgClass}
